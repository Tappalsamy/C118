...
def save():
    ...
    with open("C:/Users/trist/Downloads/PRO-C118-Project-Boilerplate-main (1)/PRO-C118-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv","a") as x:
